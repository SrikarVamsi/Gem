...
Option 1: Chrome Extension (Full Experience) 
- Check the Quick Start section  ([⚡ Quick Start](#-quick-start-local-setup)) to see how to run the backend before adding the extension to Chrome.
